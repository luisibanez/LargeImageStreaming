...
10 different blocks. Given $z$ the number of slices on a dataset, $f$ the number of filters involved
...
\begin{center}
 ...
 \hline
Read and Write & & 141.137\\
Binarization & & 103.206 \\
Noise removal & & 1075.76 \\
Hole-filling (iteration 1) & & 2399.96 \\
Hole-filling (iteration 1) & & 2436.57\\
Hole-filling (iteration 1) & & 2414.11\\
Subtraction & & 223.576\\
 \hline
\end{tabular}
\end{center}
