...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/ReadWriteTest_hunc34_14_a_Slice.png}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/BinaryThresholdTest_hunc34_14_a_Slice.png}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/VotingHoleFillingTest_01_hunc34_14_a_Slice.png}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/VotingHoleFillingTest_02_hunc34_14_a_Slice.png}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/VotingHoleFillingTest_03_hunc34_14_a_Slice.png}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/VotingHoleFillingTest_04_hunc34_14_a_Slice.png}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/SubtractImageTest_hunc34_14_a_Slice.png}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/BinaryThresholdTest_hunc34_14_a_float_Slice.png}
\itkcaption[Binary Image]{Middle slice from the binary image.}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/VotingHoleFillingTest_01_hunc34_14_a_float_Slice.png}
\itkcaption[Island Removal Image]{Middle slice from the image after island removal.}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/VotingHoleFillingTest_02_hunc34_14_a_float_Slice.png}
\itkcaption[Hole Filling 1 Iteration]{Middle slice from the image after one iteration of hole filling.}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/VotingHoleFillingTest_03_hunc34_14_a_float_Slice.png}
\itkcaption[Hole Filling 2 Iterations]{Middle slice from the image after two iteration of hole filling.}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/VotingHoleFillingTest_04_hunc34_14_a_float_Slice.png}
\itkcaption[Hole Filling 3 Iterations]{Middle slice from the image after three iteration of hole filling.}
...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{../../Testing/Temporary/SubtractImageTest_hunc34_14_a_float_Slice.png}
\itkcaption[Subtraction]{Middle slice from the subtraction image.}
